...
import { idlFactory } from './atomic_swap.did.js';
export { idlFactory } from './atomic_swap.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ATOMIC_SWAP;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./atomic_swap.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the atomic_swap canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./atomic_swap.did.js")._SERVICE>}
 */
export const atomic_swap = createActor(canisterId);
