...
import { idlFactory } from './price_oracle.did.js';
export { idlFactory } from './price_oracle.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PRICE_ORACLE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./price_oracle.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the price_oracle canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./price_oracle.did.js")._SERVICE>}
 */
export const price_oracle = createActor(canisterId);
