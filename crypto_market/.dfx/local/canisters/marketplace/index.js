...
export const canisterId = process.env.CANISTER_ID_MARKETPLACE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./marketplace.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the marketplace canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./marketplace.did.js")._SERVICE>}
 */
