...
class CanisterConfig {
  ...
  static const Map<String, String> mainnet = {
    'user_management': String.fromEnvironment(
      'CANISTER_ID_USER_MANAGEMENT_MAINNET',
      defaultValue: '',
    ),
    'marketplace': String.fromEnvironment(
      'CANISTER_ID_MARKETPLACE_MAINNET',
      defaultValue: '',
    ),
    'atomic_swap': String.fromEnvironment(
      'CANISTER_ID_ATOMIC_SWAP_MAINNET',
      defaultValue: '',
    ),
    'price_oracle': String.fromEnvironment(
      'CANISTER_ID_PRICE_ORACLE_MAINNET',
      defaultValue: '',
    ),
  };
  ...
  static String getCanisterId(String canisterName) {
    ...
    if (canisterId == null || canisterId.isEmpty) {
      throw Exception(
        'Canister ID not configured for $canisterName in ${EnvironmentConfig.current} environment',
      );
    }
    return canisterId;
  }
