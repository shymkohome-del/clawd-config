...
## Recommended chronological drafting order (Phase 1)
1) E1.S1 Register with email/social (ICP principal mapping)
2) E2.S1 Create listing
3) E3.S1 Initiate swap (HTLC) with timelock/hashlock
4) E7.S1 Open dispute (manual moderation)
