...
1. `ICPService` skeleton exists with initialization hooks for market, user_management, atomic_swap, price_oracle. [Source: architecture/frontend-architecture.md#frontend-services-layer]
