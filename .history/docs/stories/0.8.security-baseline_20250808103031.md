...
3. Non-functional security requirements referenced and tracked (GDPR/CCPA mention from PRD 5.2). [Source: prd/5-non-functional-requirements.md#5.2-security-requirements]
