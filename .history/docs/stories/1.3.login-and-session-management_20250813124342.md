...
- [ ] Frontend: Login UI and provider (AC: 1)
  - [ ] Implement `authenticate(email, password)` flow and state handling. [Source: architecture/api-specification.md#user-management-canister]

- [ ] Frontend: Session management (AC: 2, 3)
  - [ ] Secure storage for tokens/principal, expiry handling, logout control. [Source: architecture/security-and-performance.md#security-requirements]
