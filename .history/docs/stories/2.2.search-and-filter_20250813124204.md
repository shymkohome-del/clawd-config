...
- UI in `lib/features/marketplace/screens/home_screen.dart`, filters in shared widgets; service via ICP layer. [Source: architecture/frontend-architecture.md#frontend-services-layer]
