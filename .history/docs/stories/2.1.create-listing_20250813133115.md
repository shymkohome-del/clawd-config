...
- [ ] Frontend: Add Create Listing UI in `lib/features/market/` with validation and submission (AC: 1)
  ...
  - [ ] Implement Riverpod provider for listing creation state, loading, and error handling. [Source: architecture/frontend-architecture.md#state-management-architecture]
...
- Frontend feature module under `lib/features/marketplace/` for listing creation UI and provider. [Source: architecture/frontend-architecture.md#flutter-app-structure]
