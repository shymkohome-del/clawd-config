...
- Post-merge cleanup:
  - Verify branch deletion occurs after squash merge; protected branches are skipped with a clear note.
- Metrics completeness:
  - Ensure summaries include: created vs reused PR, auto-merge attempted/enabled, checks green, auto-update attempted, need rebase, and final action.
- Matrix runs:
  - Run against merged and non-mergeable PRs to cover all code paths; confirm metrics remain deterministic.
