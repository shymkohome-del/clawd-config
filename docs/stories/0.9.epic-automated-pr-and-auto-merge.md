...
| 2025-08-19 | 0.5 | Dev: Standardized reason keys and expanded job summaries; exposed auto-merge outputs (attempted/enabled/reason); YAML lint fixed; local validation green; work committed on `story/0.9.3-auto-merge`. | Dev |
| 2025-08-19 | 0.6 | QA: Updated — Phase 7 (0.9.8) now Pass after metrics expansion and cleanup verification. Epic remains InProgress. | QA |
...
- Phase 7 (0.9.8): Pass. Cleanup verified; metrics include created vs reused, auto-merge attempted/enabled, and explicit block reasons.
...
- Current state by phase:
  ...
  - Cross-cutting: Reason keys standardized across workflows; job summaries expanded; auto-merge outputs (attempted/enabled/reason) exposed
