...
- [ ] Frontend: Swap initiation UI and provider (AC: 1)
  - [ ] Create `SwapScreen` entry flow from listing detail, generate secret and secretHash. [Source: architecture/frontend-architecture.md#flutter-app-structure]
  - [ ] Use Riverpod provider to manage swap state, including loading/error. [Source: architecture/frontend-architecture.md#state-management-architecture]
