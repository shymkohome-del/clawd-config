...
- Next:
  - Keep fallback as source of truth; when repo enables auto-merge, prefer GraphQL enable path. Validate repo settings: enable global Allow auto-merge and ensure squash allowed on `develop` with required checks.
