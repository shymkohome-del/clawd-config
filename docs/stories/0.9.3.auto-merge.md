...
| 2025-08-20 | 0.5 | Dev: Reusable workflow now outputs auto-merge `attempted/enabled/reason` and emits job summary; fallback merge workflow uses retries. Pending repo setting to allow GraphQL enable. Status InProgress. | Dev |
