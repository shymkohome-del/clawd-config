...
| ---- | ------- | ----------- | ------ |
| 2024-06-10 | 0.1 | Initial draft — SM story for main merge gate (develop + label). | Scrum Master |
...
- `dart format --output=none --set-exit-if-changed .` (formatted files) — ✓ Passed
- `flutter analyze --fatal-infos --fatal-warnings` — ✓ Passed
