...
| 2025-08-14 | 0.5 | Dev: Added ; ran format/analyze/tests; ready for QA | Dev Agent |
| 2025-08-14 | 0.6 | QA: Status set to InProgress — AC1 still missing `.env.example`; AC2/AC3 met | QA Agent |
