...
- [ ] Frontend: Cancel UI (AC: 1)
  ...
  - [ ] **Logging: Implement debug logging for cancellation attempts, reason selections, swap state verification, notification delivery, and cancellation completion events. Ensure logging is disabled in production flavors and only active in development/staging builds.**
