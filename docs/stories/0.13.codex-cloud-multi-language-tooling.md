## 0.13 Codex Cloud multi-language tooling (Flutter + Motoko)

**Status: Done**

**Dev Agent Record**
- [x] Extended `scripts/codex_setup.sh` with `CODEX_SETUP_MOTOKO` and `CODEX_SETUP_RUST` toggles
- [x] Added Node.js version checks and optional tool installers
- [x] Created `scripts/codex_verify.sh` for environment validation
- [x] Updated documentation and AGENTS cross-links

**File List**
- Added: scripts/codex_verify.sh
- Modified: scripts/codex_setup.sh
- Modified: docs/Codex-Cloud-Environment.md
- Modified: AGENTS.md
- Added: docs/stories/0.13.codex-cloud-multi-language-tooling.md

**Change Log**
- 2025-09-01: Initial multi-language Codex Cloud tooling with optional Motoko and Rust installs
...
- ✅ Flutter/Dart tooling installed and verified via `codex_setup.sh` and `codex_verify.sh`
- ✅ Default gates pass: `dart format`, `flutter analyze`, `flutter test --no-pub`
