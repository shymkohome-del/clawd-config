...
- [ ] Frontend: Profile UI (AC: 1)
  - [ ] Create `ProfileScreen` for user profile display and editing. [Source: architecture/frontend-architecture.md#flutter-app-structure]
  - [ ] Add profile form with image picker. [Source: prd/4b-user-stories-and-acceptance.md#e1-user-identity]
  - [ ] Display reputation score and trust badge. [Source: architecture/data-models.md#user-model]
  - [ ] **Localization: Implement multi-language support for profile labels, field placeholders, validation messages, and reputation indicators using Flutter's i18n framework.**
